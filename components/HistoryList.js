...
const FRIENDLY_LABELS = {
  ...
  withheldTax: 'Tax withheld during year',
  balanceDue: 'Balance payable at 1700',
  overpayment: 'Overpayment (refundable)',
  smwAnnual: 'Statutory minimum wage (annual)',
  foreignIncomeExempt: 'Foreign income (exempt)',
  estateTrustTax: 'Estate/trust income tax',
  corpGrossSales: 'Corporate gross sales',
  corpDeductions: 'Corporate deductions',
  corpYears: 'Years in operation',
  corporateTax: 'Corporate income tax',
  grossRentals: 'Gross rentals',
  rentalExpenses: 'Rental expenses',
  monthlyRentPerUnit: 'Monthly rent per unit',
  routeChosen: 'Route chosen',
  passiveType: 'Passive income type',
  grossAmount: 'Gross amount',
  acquisitionCost: 'Acquisition cost',
  taxableBase: 'Taxable base',
  finalTax: 'Final tax',
  netReceipt: 'Net amount kept',
  method: 'Method',
  quarters: 'Quarters entered',
  cumulativeTax: 'Cumulative tax',
  payable: 'Payable',
  totalPaid: 'Total paid across quarters',
  annualTaxEstimate: 'Annual tax estimate',
