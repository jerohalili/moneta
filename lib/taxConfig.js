...
// Live rate layer over data/taxRates2026.js defaults (TRAIN RA 10963) + localStorage overrides.
// Hydration: RATES starts as a defaults copy; applyStoredOverrides() runs once after mount.

export const RATES = { ...DEFAULTS }

const STORAGE_KEY = 'rate-overrides'

// Registry: what's editable and how to describe it (see RATE_GROUPS / RATE_REGISTRY).
