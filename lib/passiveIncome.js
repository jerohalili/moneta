...
// Passive income bears FINAL tax at source, never part of graduated ITR.
// No filing/deductions/brackets — rate hits base (NIRC Secs. 24(B)(1), 24(C), 57(A)).
...
// Compute final tax for a passive-income type; share sales use gain, prizes net of exemption.
export function birComputePassiveIncomeTax({ typeId, gross, cost = 0 }) {
...
// Back-compat alias — prefer birComputePassiveIncomeTax in new code.
export const computePassiveIncomeTax = birComputePassiveIncomeTax
